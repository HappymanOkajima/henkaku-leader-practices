...
<!-- 注: 3つの壁を縦に並べた構造図。各壁に対して「課題」と「突破事例」を対比表示。壁1「年功序列と心理的安全性のジレンマ」→突破「サイボウズ：100人100通りのマッチング」「ザカモア：役職・評価廃止、社員が年俸決定」。壁2「レガシーシステムと技術革新の両立」→突破「北國銀行：勘定系クラウド化、非減点主義」。壁3「受託体質からの脱却」→突破「永和システムマネジメント：さきのこと（売上計画ゼロ、年間2億円×3年投資）」。右側に共通の成功要因として「心理的安全性」「経営の一ひねり」「長期的視点」を配置 -->
...
<!-- 注: 中央に竹とんぼのイラストを配置し、螺旋を描きながら上昇する様子を視覚化。竹とんぼの羽根を「ビジョンの引力」「外からの引力」「内なる力」の3色で塗り分け。最下部に「経営の一ひねり」として手のアイコンを配置し、初期推進力を与える場面を表現。螺旋軌道に沿って「小さな成功」→「学習の蓄積」→「能力の向上」→「新たな挑戦」のサイクルを記載。右側に「ロケット型（継続的燃料供給）」との対比図を小さく配置し、竹とんぼ型の「自律的上昇」との違いを強調 -->
...
【図表 6-4: 4社の変革アプローチ比較マトリクス】
<!-- 注: 2軸のマトリクス図。横軸に「変革のスピード」（漸進的←→急進的）、縦軸に「変革の主体」（トップダウン←→ボトムアップ）を配置。4社をプロットし、各社の特徴を吹き出しで記載。サイボウズ：左上エリア（漸進的・トップ主導の制度設計）「段階的な制度改革、10年以上かけた文化醸成」。北國銀行：中央上部（中間的・経営主導だが全員参加）「20年の準備期間、全行員参加型DX」。永和：右下エリア（急進的・現場主導）「さきのこと：売上ゼロで即座に開始」。ザカモア：右上エリア（急進的・トップの大胆な決断）「一気に役職廃止、代表3年不在」。各社を結ぶ矢印で「学び合い」の関係を示唆 -->
