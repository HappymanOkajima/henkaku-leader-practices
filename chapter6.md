...
【図表 6-1: 日本企業が直面する3つの壁と突破事例】（*注: 3つの壁を縦に並べた構造図。各壁に対して「課題」と「突破事例」を対比表示。壁1「年功序列と心理的安全性のジレンマ」→突破「サイボウズ：100人100通りのマッチング」「ザカモア：役職・評価廃止、社員が年俸決定」。壁2「レガシーシステムと技術革新の両立」→突破「北國銀行：勘定系クラウド化、非減点主義」。壁3「受託体質からの脱却」→突破「永和システムマネジメント：さきのこと（売上計画ゼロ、年間2億円×3年投資）」。右側に共通の成功要因として「心理的安全性」「経営の一ひねり」「長期的視点」を配置*）
...
【図表 6-2: 竹とんぼ型スパイラルアップモデル概念図】（*注: 中央に竹とんぼのイラストを配置し、螺旋を描きながら上昇する様子を視覚化。竹とんぼの羽根を「ビジョンの引力」「外からの引力」「内なる力」の3色で塗り分け。最下部に「経営の一ひねり」として手のアイコンを配置し、初期推進力を与える場面を表現。螺旋軌道に沿って「小さな成功」→「学習の蓄積」→「能力の向上」→「新たな挑戦」のサイクルを記載。右側に「ロケット型（継続的燃料供給）」との対比図を小さく配置し、竹とんぼ型の「自律的上昇」との違いを強調*）
...
内向きの改革は必ず行き詰まります。社会課題の解決、顧客価値の創造、市場からのフィードバック。これらの「外からの引力」が、組織を正しい方向へ導きます。北國銀行がFinTech（金融とITを融合した新しいサービス）の急速な進化に対応できたのも、この外部志向があったからです。
...
【図表 6-3: 3つの原動力が生み出すスパイラル効果】（*注: 三角形の頂点に3つの原動力を配置した図。上頂点「ビジョンの引力（方向性）」には北極星アイコンと各社ビジョン（チームワークあふれる社会、次世代版地域総合会社、Permanent Agility）を記載。左下「外からの引力（市場適応）」には顧客・社会アイコンと「顧客価値創造」「社会課題解決」「市場フィードバック」を記載。右下「内なる力（内発的動機）」には社員アイコンと「自分事化」「主体的行動」「ジョブボード、特命係」を記載。三角形の中央に「スパイラル効果」として螺旋矢印を配置し、「小さな成功→自信→新たな挑戦」のサイクルを表現。下部にフライホイール効果との比較注釈*）
...
【図表 6-4: 4社の変革アプローチ比較マトリクス】（*注: 2軸のマトリクス図。横軸に「変革のスピード」（漸進的←→急進的）、縦軸に「変革の主体」（トップダウン←→ボトムアップ）を配置。4社をプロットし、各社の特徴を吹き出しで記載。サイボウズ：左上エリア（漸進的・トップ主導の制度設計）「段階的な制度改革、10年以上かけた文化醸成」。北國銀行：中央上部（中間的・経営主導だが全員参加）「20年の準備期間、全行員参加型DX」。永和：右下エリア（急進的・現場主導）「さきのこと：売上ゼロで即座に開始」。ザカモア：右上エリア（急進的・トップの大胆な決断）「一気に役職廃止、代表3年不在」。各社を結ぶ矢印で「学び合い」の関係を示唆*）
...
永和システムマネジメントのアジプラも同様です。専門知識を一部の専門家に閉じ込めるのではなく、全社にサービスとして提供する。マーケティング、広報、人材育成、採用支援といった形で、組織全体にアジャイルのマインドセットを浸透させていく。これは第3章で述べたSECIモデルとLearning-as-a-Serviceの実践であり、知識を部署に閉じ込めず、組織全体に循環させていくプロセスです。
...
【図表 6-5: 日本企業の強みを活かした変革戦略フレームワーク】（*注: 3つの強みを柱として配置した構造図。左柱「改善文化の活用」：トヨタ生産方式アイコン、「全員参加」「継続的改善」「現場主義」のキーワード、実践例として北國銀行の全行員兼業DXと永和のアジプラを記載。中央柱「価値創造の民主化」：ネットワークアイコン、「個人の自律性」「集団の調和」「主体的キャリア」のキーワード、実践例としてサイボウズの100人100通りと市場価値連動報酬を記載。右柱「長期的視点」：時計・カレンダーアイコン、「持続的変革」「じっくり取り組む」「両利きの経営」のキーワード、実践例として北國銀行20年準備と永和19年アジャイル追求を記載。3本柱の上に「日本的アジャイル経営」のゴールを配置し、下部に「段階的導入戦略」への矢印*）
