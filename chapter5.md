...
【図表 5-4: FDO 3年間のOKR進化と成果】
<!-- 注: 3つのカラムで3年間を比較する構成。各年度のObjective、Key Results、成果、課題を整理。41期（2021年度）：曖昧なO「新技術を幅広く獲得」→結果「バベルの塔」（方向性散漫）。42期（2022年度）：チーム重視O「アジャイルに機械学習を学ぶ」→結果「チームワーク向上」だが「技術獲得ペース低下」。43期（2023年度）：価値創出O「AIで実務価値を生み出す」→結果「就業規則Bot」「対話型ロボット」「コンペ12位」の具体的成果。下部に「OKRの成熟度」を1-5段階で視覚化（41期:2、42期:3、43期:4.5）。ピボットの判断（強化学習→自然言語処理）を転換点として強調 -->
