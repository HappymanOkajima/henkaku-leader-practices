...
「うちの部門でもAIを使っている人はいるけど、結局その人だけで終わっているんです」

2024年のある日、社内ミーティングで若手社員からこんな声が上がりました。皆さんの組織でも、同じような状況はありませんか？　私も正直に言えば、この言葉にハッとさせられました。

第3章では、FDOの3年間を通じて、SECIモデルを意図的に実践した組織学習と、そこから発見された「育てて返す」モデルをお伝えしました。期間限定で人材を受け入れ、知識を付与して返す。このモデルは、知識を組織全体に循環させる強力な仕組みでした。

しかし2023年、ChatGPTの登場により、組織の知識創造は新たな局面を迎えました。AIの急速な普及は、個人の生産性を劇的に向上させました。しかし、真の変革は個人レベルではなく、組織レベルで起きます。本章では、故野中郁次郎教授が晩年まで思索されたAI時代のSECIモデルを基盤に、AIを単なるツールとしてではなく、組織全体の能力として内在化させる方法を探ります。
...
![図4-1](figures/pic4-1.png)
【図表 4-1: 永和システムマネジメント AI活用4年間の変遷タイムライン】
<!-- 注: 横軸に時間（2021年〜2025年）を配置したタイムライン図。上部には世界のAI動向（GPT-3発表、ChatGPT公開、GPT-4リリース、エージェントAI時代）を、下部には永和の取り組み（FDO実験開始、ChatGPT利用補助開始、全社アンケート実施、フロネシス・プログラム立上げ）を対応させて表示。各マイルストーンをアイコンと短い説明で示し、「個人的試行」→「部門内活用」→「組織能力化」という成熟度の変遷を色のグラデーションで表現する -->
...
![図4-2](figures/pic4-2.png)
【図表 4-2: 全社AI活用アンケート結果サマリー（2025年6月）】
<!-- 注: ダッシュボード形式の図。左上に「毎日利用率56.3%」の円グラフ、右上に部門別毎日利用率の棒グラフ（アジャイル部門92.0%、管理部門38.9%、医療システム部門28.1%）、左下に最も利用するツールランキング（ChatGPT 73名、Gemini 16名、GitHub Copilot 12名）、右下に「期待」と「不安」を対比した横棒グラフ（業務効率向上192名 vs 情報の正確性懸念164名、機密情報漏洩リスク148名、過度な依存89名）を配置。全体で215名回答という規模感と、組織のAI活用の現状を一目で把握できるデザイン -->
...
**第1層：知識共有層**
部門横断のAIチャンピオンやエバンジェリストのネットワークです。彼らは各部門でAI活用の「火付け役」となり、小さな成功事例を作り出します。重要なのは、彼らが「専任」ではなく「兼任」であることです。通常業務を持ちながらAI活用を推進することで、実践的な知見が蓄積されるのです。

**第2層：深い実践層**
専門チームが先端技術を探求し、概念実証（PoC）から本番実装まで担います。ここでは「失敗を恐れない」文化が不可欠です。多くの実験を行い、そこから学習することで、組織としての技術力が向上するのです。

**第3層：外部対話層**
コミュニティや顧客との対話を通じて、内部の実践を検証し、新たな気づきを得ます。外部発信することで、思わぬフィードバックや協業の機会が生まれることもあります。既存のマーケティング・広報機能をX-as-a-Serviceモデルで活用することで、専門性を持った支援が可能になるのです。

この3層が相互に作用することで、組織全体にAI活用の好循環が生まれます。
![図4-3](figures/pic4-3.png)
【図表 4-3: 組織的AI活用の3層構造モデル】
<!-- 注: 三層のピラミッドまたは同心円で表現。最下層（または中心）に「第1層：知識共有層」（AIチャンピオン、エバンジェリスト、兼任での火付け役）、中層に「第2層：深い実践層」（専門チーム、PoC〜本番実装、失敗を恐れない文化）、最上層（または外周）に「第3層：外部対話層」（コミュニティ対話、顧客フィードバック、X-as-a-Service活用）を配置。各層間を双方向の矢印で結び、相互作用による好循環を表現。右側に永和での実装例（プロメテウス、バベル、アゴラ）を対応させて表示する -->
...
![図4-4](figures/pic4-4.png)
【図表 4-4: フロネシス・プログラム全体像】
<!-- 注: 3つのプロジェクトを中心に据えた構造図。中央に「フロネシス（実践知）」のコンセプトを配置し、そこから3つの方向に「プロメテウス（CoE）：火をともし、分け与え、知恵を体系化する」「バベル（プロダクト）：言語の壁を打ち破る破壊的AI駆動開発」「アゴラ（外部発信）：Communication-as-a-Serviceによる知識循環」を展開。各プロジェクトにはチーム規模（12名、2-3名、アジプラ連携）、活動頻度（週1時間、フルタイム、伴走支援）、主要目標を簡潔に記載。背景に野中郁次郎教授のSECIモデルとの関連を薄く示す -->
...
AIチャンピオンネットワークの効果は、単なる情報共有を超えています。プロメテウスの定例会議では、早くも部門間の知識循環が始まりました。

印象的だったのは、管理部が導入したAI OCR（光学文字認識）の事例です。管理部メンバーが定例会議で「手書きの領収書も読み取れ、請求日や支払い先を自動識別できる」と紹介したところ、医療システム部門のメンバーがすぐに反応しました。「営業事務の2名が管理部の請求業務とほぼ同じ作業をしている。この機能を活用できないか」。異なる事業部でも、本質的な課題が共通していることに気づいた瞬間でした。

このような「越境学習」が起きやすいのも、AIの特徴です。AIは汎用技術であるため、ある領域での学習が他の領域にも転用可能です。プロメテウスの参加者の一人は、こう振り返っています。「他の事業部の取り組みを知る良い機会となった。自分の事業に取り入れたい」。この特性を活かすためにも、部門横断の学習ネットワークは不可欠なのです。
...
では、組織がAIを活用して価値を生み出そうとするとき、その「価値」をどう測ればいいのでしょうか？　次章では、価値を測定することの難しさと罠について探ります。私自身が2000万円の投資を失ったHIKKOSHIプロジェクトの失敗から学んだこと、そしてOKRという目標管理手法が教えてくれた「測定可能なものが必ずしも重要ではない」という逆説について、一緒に考えていきましょう。
