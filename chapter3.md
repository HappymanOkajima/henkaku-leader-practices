...
「せっかく学んだ新しい技術が、その人だけで終わってしまう」

皆さんは、こんな経験はありませんか？　研修に参加して熱心に学んできたメンバーが、元の部署に戻ったとたん、日常業務に埋もれてしまう。私も何度もそんな場面を見てきました。

個人が学んだ知識を、どうやって組織全体に広げるか。この古典的な課題に対して、私たちは3年間の実験を通じて、一つの答えを見出しました。

2020年8月、私たちは「FDO（Future Design Office）」という部門横断プロジェクトを立ち上げました。AI、IoT、ロボティクス、XR（AR/VR）といった急速に進化する技術領域で、次世代のエースを育成し、組織に技術を根付かせる。この野心的な目標に向けて、私たちは野中郁次郎教授が提唱する「SECIモデル」を学習フレームワークとして採用しました。
...
SECIモデルは、野中郁次郎教授が提唱した知識創造理論です。知識には「暗黙知」（言葉にしにくい経験やコツ）と「形式知」（言語化・文書化された知識）の2種類があり、この2つが相互に変換されながら組織全体に広がっていく、という考え方です。

SECIモデルは、知識創造を4つの変換プロセスとして捉えます：

**共同化（Socialization）**：暗黙知を暗黙知として共有する
- 実務を通じて先輩や熟練者と共に働き、言葉にならない「コツ」や「勘」を体感する
- 一緒に作業しながら、思考プロセスや判断の仕方を共有する
...
- 複数の知識を組み合わせ、マニュアルや報告書として体系化する
- 蓄積した知識を整理し、組織の財産として活用できる形にする

**内面化（Internalization）**：形式知を暗黙知として実践する
- マニュアルや資料を読んで学び、自分の現場で応用する
- 他者の経験を自分の文脈に「翻訳」して使いこなす

このサイクルを回すことで、個人の経験が組織の知識へと螺旋的に拡大していきます。

SECIサイクルは、いわば「知識の螺旋階段」のようなものです。同じ場所を回っているように見えても、一周するごとに一段高いところに登っている。個人の暗黙知が、チームの形式知になり、組織全体の財産へと昇華していくのです。

FDO設立時、私たちは明確な課題に直面していました。AI、IoT、ロボティクスなど急速に進化する技術領域を、限られた期間でどうキャッチアップするか。個人が学んだ知識を、どうやって組織全体に広げるか。この問いに対する答えとして、FDOはSECIモデルを学習プロセスの骨格として採用しました。
...
3. **認知度の向上**：「〇〇やってる永和さんね」と思い出してもらえる存在になる

注目すべきは、2つ目のミッションです。「エースを育成する」。当時の私たちは、新しい技術領域の専門家集団を社内に作ることを想定していました。FDOで育ったエースたちが、先端技術プロジェクトを牽引する。そんなイメージでした。

しかし3年後、私たちが発見したのは、まったく異なる価値でした。

FDOは、事業部から最大1年間メンバーを受け入れ、プロダクト開発を通じて新しい技術を獲得させる部門横断プロジェクトとして設計されました。重要なのは、メンバーは期間終了後、必ず元の事業部に戻るという点です。この設計が、後に重要な意味を持つことになります。

![図3-1](figures/pic3-1.png)
【図表 3-1】FDO 3年間のタイムライン（41期〜43期）
<!-- 【図表 3-1】FDO 3年間のタイムライン 生成AI（画像生成）への指示：以下の内容を横型タイムライン図として作成してください。■ 全体構成 - 横軸：時間軸（2020年8月〜2023年7月）- 3つの期（41期・42期・43期）を色分けして区切る - 各期の下に主要な出来事をマイルストーンとして配置 ■ 41期（一期生）2020年8月〜2021年7月 - メンバー：3名（Ruby経験者、組込み系SE、業務系SE）- テーマ：AI・機械学習領域の探索 - 成果物：育てるAI検温（非接触型体温計） - キーワード：SECIサイクル初回転、形式知化の基盤構築 ■ 42期（二期生）2021年10月〜2022年7月 - メンバー：4名（Web系2名、金融系2名）- テーマ：機械学習に特化（「他社に教えられるレベル」目標）- 成果物：機械学習教育サービス教材、Bee（書籍レコメンドSlackアプリ）- キーワード：一期生の形式知を継承、アジャイル運営導入 ■ 43期（三期生）2022年10月〜2023年7月 - メンバー：2名（ML経験者のWeb系エンジニア）- テーマ：技術力のエビデンス重視、強化学習→自然言語処理へ転換 - 成果物：就業規則Bot、対話型ロボット（GPT-3.5-turbo）- キーワード：ChatGPT登場への即応、コンペ12位/357チーム ■ デザイン指示 - シンプルで読みやすいビジネス資料風 - 各期を異なる色（例：青→緑→オレンジ）で区別 - 矢印で「形式知の継承」の流れを示す - 日本語テキスト、横書き -->

## 1年目：SECIサイクルを完成させる

### 一期生（2020年8月-2021年7月）：多様性からのスタート

一期生は3名でスタートしました。Ruby経験者、組込み系SE、業務系SE——バックグラウンドがまったく異なる3人です。当初は共通言語を見つけるのに苦労しました。けれども、この多様性こそが、創発的な学びの源泉となったのです。

AI・機械学習領域をテーマに選んだのは、その広大さと不確実性ゆえでした。すべてをマスターすることは不可能です。だからこそ、チームで学び、SECIサイクルを回すことが重要だったのです。

### 第1四半期：共同化（Socialization）

最初の四半期は、実際の案件を通じて「暗黙知」を体感することに焦点を当てました。ちょうど同時期に他部署で実施されていた研究開発プロジェクトを支援する形で、AI（機械学習）領域を体験したのです。
...
この時期、FDOは機械学習だけでなく、ARやUnityといった技術領域も並行して探索していました。当初の計画通り、AI、IoT、XRなど幅広い技術に触れながら、チームとして何にフォーカスすべきかを模索していたのです。

そうした探索の中で、機械学習コンペティションへの挑戦が転機となりました。チームで対話しながら、「なぜこのアプローチを選んだのか」「何が難しかったのか」を言葉にしていく。週次の振り返りでは、「前処理8割」という言葉の真の意味を体感したこと、予測率の目標設定の危険性、統計知識の重要性など、多くの気づきが共有されました。この経験を通じて、FDOは徐々に機械学習領域へとフォーカスを絞っていくことになります。
...
二期生は4名でスタートしました。Web系と金融系から各2名という部門横断構成です。41期の経験を踏まえ、42期では技術領域を明確に「機械学習」に絞り込みました。目標は「機械学習プロジェクトの進め方を他社に教えられるレベルにする」こと。機械学習教育サービスの教材開発をメインテーマとして設定したのです。

ここで重要な変化がありました。二期生は、一期生が残した形式知（ドキュメント）からスタートできたのです。

ゼロから暗黙知を体感する必要はありません。一期生の経験が言語化されているため、理論から学び、より早く実践に移れるのです。これはSECIモデルの「内面化」から「共同化」へのサイクルが、世代を超えて機能している証拠でした。
...
三期生は2名、どちらもWeb系の所属でした。部門横断という当初の理念からは遠ざかりましたが、これには明確な意図がありました。43期は「技術力のエビデンス」に特化し、質の高い成果にフォーカスする方針だったのです。

両名とも既に機械学習の経験を持つエンジニアでした。そこで、アウトプットをプロダクトに限定せず、論文やコンペなど多様な形での成果を認める方針としたのです。この経験者構成だからこそ、より高度な領域への挑戦が可能になりました。

最も印象的だったのは、強化学習への挑戦とその後の方向転換です。8月から9月は「実験フェーズ」として位置づけられていました。10月からのフル稼働に向けて、どの領域を深掘りするかを探る期間です。

「AlphaGoのような、自己対戦で学習するAIを作りたい」。機械学習経験者だからこそ挑戦できる高い目標を掲げました。しかし、強化学習の理論は複雑で、実装はさらに困難でした。実験フェーズの2ヶ月間取り組みましたが、期待した成果には届きませんでした。

このペースでは年間を通じても十分な成果が見込めない。そう判断した第2四半期の終わりに、強化学習から自然言語処理へと方向転換しました。一見「失敗」に見えますが、これは戦略的な判断でした。限られたリソースを最大限活かすための柔軟性こそが、学習する組織の本質です。

実際、自然言語処理への転換は功を奏しました。ちょうどChatGPTが登場したタイミングで、就業規則Botや対話型ロボットといった実用的な成果物を生み出すことができました。ブルーカーボン・ダイナミクスコンペでは357チーム中12位という成績を収めました。

三期生の経験から学んだのは、うまくいかないと判断したら、素早く方向を変える勇気です。SECIモデルの「学習」は、固執することではなく、適応することなのだと実感しました。
![図3-2](figures/pic3-2.png)
【図表 3-2: FDO3年間のSECI実践の変遷】
<!-- 注: 2×2マトリクス図。縦軸「多様性」（低→高）、横軸「専門性」（低→高）。3つの楕円で各期を配置：①41期（一期生）は左上「多様性高・専門性低」領域に緑色楕円、ラベル「共同化(S)重視」「3名・3部門横断」。②42期（二期生）は中央やや右上に黄色楕円、ラベル「表出化(E)重視」「4名・成果物重視」。③43期（三期生）は右下「多様性低・専門性高」領域に青色楕円、ラベル「連結化(C)重視」「2名・ML特化」。各楕円を点線矢印で時系列につなぐ。右下に小さくSECIサイクルの円環図を配置し、S→E→C→Iの流れを示す。全体のメッセージ：「3年間でSECIの異なるフェーズを自然に経験した」 -->
...
私たちは「先端技術のエース集団」を作ろうとして、その点では期待通りの成果を上げられませんでした。FDOは解散しましたし、先端技術の専門部署も残りませんでした。
...
通常、目標が達成できないとき、私たちは「どうすればうまくいくか」を考えます。しかしFDOでは「そもそも、なぜ先端技術のエース集団が必要なのか？」「本当に専門部署が正しいアプローチなのか？」と、前提自体を問い直しました。
...
【図表 3-3: 知識が組織に浸透する仕組み - SECIモデルの組織的実践】
<!-- 注: 二重螺旋構造の概念図。中央に「FDO」を表す小さな円環（SECIサイクル：S共同化→E表出化→C連結化→I内面化）を配置。この小さな円環の周囲に、放射状に3つの部署アイコン（「Web系」「アジャイル系」「組込み系」）を配置。FDOから各部署へ「卒業生」を示す人型アイコンと矢印が伸びる。各部署でも小さなSECIサイクルが回っている様子を示す。全体を包む大きな螺旋矢印で「組織全体のSECIサイクル」を表現。螺旋は上昇するように描き、「知識の螺旋的拡大」を視覚化。色使い：ビジネス書向けにシンプルに -->
...
従来の研修は「教えて終わり」でした。専門部署は「知識を囲い込む」傾向があります。しかしFDOは違いました。1年間という期間限定で各部門から人材を受け入れ、最新技術を習得させ、元の部署に返す。卒業生は各部署で技術伝道師となり、知識を実務に応用していくのです。
...
FDOは単なる教育機関ではなく、組織の知識循環を促進する「サービス」だったのです。SaaS（Software as a Service）のように、必要な時に必要なサービスを提供するクラウド型のビジネスモデルがあります。FDOは、この考え方を組織能力に応用した「X-as-a-Service型」の仕組みでした。固定的な専門部署ではなく、期間限定で人材を受け入れ、スキルを付与して返す。振り返ってみれば、この設計こそが「育てて返す」モデルを可能にした土台だったのです。
...
年々多様性が下がっていったという反省があります。意図的に多様性を保つ仕組みが必要なのです。部門横断的なメンバー構成は維持コストが高いですが、それ以上の価値を生み出します。
...
技術のための技術ではなく、明確なニーズに基づいた活動が大切です。事業価値と直結させることで、学習の方向性が定まり、成果も見えやすくなります。
...
まず「**期間限定**」です。必要な時に、必要な期間だけ支援を提供します。支援が終われば、受け手は自走できるようになっているのです。

次に「**伴走型支援**」です。「教えて終わり」ではなく、一緒に実践します。現場の文脈に合わせて、知識を「翻訳」しながら伝えるのです。

そして「**知識の定着**」です。支援終了後も、獲得した知識とスキルは組織に残ります。依存ではなく、自律を育てる——これがX-as-a-Serviceの本質なのです。

このモデルは、固定的な組織構造から、必要に応じて形を変える流動的な組織への転換を意味しています。
![図3-4](figures/pic3-4.png)
【図表 3-4: 従来型組織とX-as-a-Service型組織の比較】
...
当初の目標は「先端技術のエース集団を作る」ことでした。しかし3年後、私たちが発見したのは、より価値のある「人を育てて返す」モデルでした。
...
本章では、人間同士の知識創造（SECIモデル）と、その組織的な実践（「育てて返す」モデル）についてお伝えしてきました。

では、このSECIモデルは、AI時代にどう進化するのでしょうか？　AIは知識創造の4つの象限のうち、どの部分を加速し、どの部分は人間に残されるのか。次章では、故野中郁次郎教授が晩年に示唆したAI時代の知識創造と、永和システムマネジメントの「フロネシス・プログラム」を通じて、AI×人間の新しい知識創造の形を一緒に考えていきましょう。
