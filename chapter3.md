...
<!--
【図表 3-1】FDO 3年間のタイムライン

生成AI（画像生成）への指示：
以下の内容を横型タイムライン図として作成してください。

■ 全体構成
- 横軸：時間軸（2020年8月〜2023年7月）
- 3つの期（41期・42期・43期）を色分けして区切る
- 各期の下に主要な出来事をマイルストーンとして配置

■ 41期（一期生）2020年8月〜2021年7月
- メンバー：3名（Ruby経験者、組込み系SE、業務系SE）
- テーマ：AI・機械学習領域の探索
- 成果物：育てるAI検温（非接触型体温計）
- キーワード：SECIサイクル初回転、形式知化の基盤構築

■ 42期（二期生）2021年10月〜2022年7月
- メンバー：4名（Web系2名、金融系2名）
- テーマ：機械学習に特化（「他社に教えられるレベル」目標）
- 成果物：機械学習教育サービス教材、Bee（書籍レコメンドSlackアプリ）
- キーワード：一期生の形式知を継承、アジャイル運営導入

■ 43期（三期生）2022年10月〜2023年7月
- メンバー：2名（ML経験者のWeb系エンジニア）
- テーマ：技術力のエビデンス重視、強化学習→自然言語処理へ転換
- 成果物：就業規則Bot、対話型ロボット（GPT-3.5-turbo）
- キーワード：ChatGPT登場への即応、コンペ12位/357チーム

■ デザイン指示
- シンプルで読みやすいビジネス資料風
- 各期を異なる色（例：青→緑→オレンジ）で区別
- 矢印で「形式知の継承」の流れを示す
- 日本語テキスト、横書き
-->
