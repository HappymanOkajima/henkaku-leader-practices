...
2020年8月、私たちは「FDO（Future Design Office）」という部門横断プロジェクトを立ち上げました。AI、AR、機械学習といった急速に進化する技術領域で、次世代のエースを育成し、組織に技術を根付かせる。この野心的な目標に向けて、私たちは野中郁次郎教授が提唱する「SECIモデル」を学習フレームワークとして採用しました。
...
FDO設立時、私たちは明確な課題に直面していました。AI、AR、機械学習など急速に進化する技術領域を、限られた期間でどうキャッチアップするか。個人が学んだ知識を、どうやって組織全体に広げるか。この問いに対する答えとして、FDOはSECIモデルを学習プロセスの骨格として採用しました。
